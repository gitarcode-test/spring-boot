...
/**
 * A {@link Task} for generating metadata describing a project's auto-configuration classes.
 *
...
public abstract class AutoConfigurationMetadata extends DefaultTask {
  ...
  private Properties readAutoConfiguration() throws IOException {
    ...
    autoConfiguration.setProperty(
        "autoConfigurationClassNames", String.join(",", publicClassNames));
