...
public final class EndpointRequest {
   ...
   * EndpointServerWebExchangeMatcher#excluding(Class...) excluding} method can be used to further
   * remove specific endpoints if required. For example:
   *
   * <pre class="code">
   ...
   * endpoints}. The {@link EndpointServerWebExchangeMatcher#excludingLinks() excludingLinks} method
   * can be used in combination with this to remove the links endpoint from {@link
  ...
  private abstract static class AbstractWebExchangeMatcher<T>
  ...
  public static final class EndpointServerWebExchangeMatcher
    ...
    @Override
    protected Mono<MatchResult> matches(
  ...
  public static final class LinksServerWebExchangeMatcher
    ...
    @Override
    protected Mono<MatchResult> matches(
        ServerWebExchange exchange, Supplier<WebEndpointProperties> context) {
      return this.delegate.matches(exchange);
    }
  }
}
