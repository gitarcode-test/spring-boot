...
/**
 * {@link ManagementContextConfiguration @ManagementContextConfiguration} for Spring MVC {@link
...
public class WebMvcEndpointManagementContextConfiguration {
  ...
  public AdditionalHealthEndpointPathsWebMvcHandlerMapping
    ...
    return new AdditionalHealthEndpointPathsWebMvcHandlerMapping(
        health, groups.getAllWithAdditionalPath(WebServerNamespace.MANAGEMENT));
  }
  ...
  /**
   * {@link WebMvcConfigurer} to apply {@link EndpointObjectMapper} for {@link
   * OperationResponseBody} to {@link MappingJackson2HttpMessageConverter} instances.
   */
