...
public class DefaultErrorAttributes implements ErrorAttributes, HandlerExceptionResolver, Ordered {
  ...
  public Map<String, Object> getErrorAttributes(
    ...
    Map<String, Object> errorAttributes =
        getErrorAttributes(webRequest, options.isIncluded(Include.STACK_TRACE));
  ...
  private void addErrorDetails(
      Map<String, Object> errorAttributes, WebRequest webRequest, boolean includeStackTrace) {
  ...
  private void addMessageAndErrorsFromBindingResult(
    ...
    addMessageAndErrorsForValidationFailure(
        errorAttributes, "object='" + result.getObjectName() + "'", result.getAllErrors());
  }
  ...
  private void addMessageAndErrorsFromMethodValidationResult(
    ...
    addMessageAndErrorsForValidationFailure(
        errorAttributes, "method='" + result.getMethod() + "'", errors);
  }

  private void addMessageAndErrorsForValidationFailure(
      Map<String, Object> errorAttributes, String validated, List<ObjectError> errors) {
    errorAttributes.put(
        "message", "Validation failed for " + validated + ". Error count: " + errors.size());
