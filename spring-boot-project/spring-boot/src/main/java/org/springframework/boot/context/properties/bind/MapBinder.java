...
class MapBinder extends AggregateBinder<Map<Object, Object>> {
    ...
    if (!hasDescendants && !ConfigurationPropertyName.EMPTY.equals(name)) {
      for (ConfigurationPropertySource source : getContext().getSources()) {
        ...
        if (property != null) {
          ...
          Object result =
              getContext().getPlaceholdersResolver().resolvePlaceholders(property.getValue());
  ...
  private Map<Object, Object> createMap(Bindable<?> target) {
    Class<?> mapType =
        (target.getValue() != null) ? Map.class : target.getType().resolve(Object.class);
  ...
  @Override
  protected Map<Object, Object> merge(
      Supplier<Map<Object, Object>> existing, Map<Object, Object> additional) {
  ...
  private class EntryBinder {
    ...
    EntryBinder(
        ConfigurationPropertyName root, Bindable<?> target, AggregateElementBinder elementBinder) {
      this.root = root;
