...
/**
 * Test utilities for adding properties. Properties can be applied to a Spring {@link Environment}
 * or to the {@link System#getProperties() system environment}.
 *
...
public final class TestPropertyValues {
  ...
  /**
   * Return a new {@link TestPropertyValues} instance with additional entries. Name-value pairs can
   * be specified with colon (":") or equals ("=") separators.
   *
   ...
   * @param mapper a mapper function to convert an element from the stream into a {@link Pair}
   * @return a new {@link TestPropertyValues} instance
   * @since 2.4.0
   */
  ...
  /**
   * Add the properties from the underlying map to the environment owned by an {@link
   * ApplicationContext}.
   *
  ...
  /**
   * Add the properties from the underlying map to the environment. The default property source used
   * is {@link MapPropertySource}.
   *
  ...
  /**
   * Add the properties from the underlying map to the environment using the specified property
   * source type.
   *
   * @param environment the environment that needs to be modified
  ...
  /**
   * Add the properties to the {@link System#getProperties() system properties} for the duration of
   * the {@code action}, restoring previous values when it completes.
   *
  ...
  /**
   * Add the properties to the {@link System#getProperties() system properties} for the duration of
   * the {@code call}, restoring previous values when it completes.
   *
  ...
  /**
   * Return a new {@link TestPropertyValues} with the underlying map populated with the given
   * property pairs. Name-value pairs can be specified with colon (":") or equals ("=") separators.
   *
  ...
  /**
   * Return a new {@link TestPropertyValues} with the underlying map populated with the given map
   * entries.
   *
   * @param map the map of properties that need to be added to the environment
   * @return the new instance
