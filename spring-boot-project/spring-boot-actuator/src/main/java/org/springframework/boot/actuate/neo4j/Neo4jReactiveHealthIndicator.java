...
/**
 * {@link ReactiveHealthIndicator} that tests the status of a Neo4j by executing a Cypher statement
 * and extracting server and database information.
 *
...
public final class Neo4jReactiveHealthIndicator extends AbstractReactiveHealthIndicator {
  ...
  /**
   * Builder used to create a {@link Neo4jHealthDetails} from a {@link Record} and a {@link
   * ResultSummary}.
   */
