...
public interface HealthEndpointGroups {
  ...
  /**
   * Return the group with the specified additional path or {@code null} if no group with that path
   * is found.
   *
  ...
  /**
   * Return all the groups with an additional path on the specified {@link WebServerNamespace}.
   *
   ...
   */
  static HealthEndpointGroups of(
      HealthEndpointGroup primary, Map<String, HealthEndpointGroup> additional) {
