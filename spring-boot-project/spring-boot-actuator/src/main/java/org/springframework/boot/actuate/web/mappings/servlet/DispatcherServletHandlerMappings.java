 ...
 * DispatcherServlet's} handler mappings, triggering initialization of the dispatcher servlet if
 * necessary.
 *
...
final class DispatcherServletHandlerMappings {
  ...
  DispatcherServletHandlerMappings(
      String name, DispatcherServlet dispatcherServlet, WebApplicationContext applicationContext) {
    this.name = name;
  ...
  private void initializeDispatcherServletIfPossible() {
    if (!(this.applicationContext
        instanceof ServletWebServerApplicationContext webServerApplicationContext)) {
      return;
    }
